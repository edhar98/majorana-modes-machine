...
which supports the noiseless-preparation idealization for this $L=4$ ansatz and
noise model -- while
...
\begin{itemize}
  ...
  \item The unital null result is the quiet payoff: it indicates that the
        noiseless-preparation idealization used elsewhere in Block~4 is not hiding an
        obvious optimistic bias for this depolarizing-noise test.

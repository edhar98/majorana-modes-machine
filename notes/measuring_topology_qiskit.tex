...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\linewidth]{../plots/block3_week5_meas_sop.pdf}
...
\begin{itemize}
  ...
  \item \textbf{Measured string:} \texttt{block3.py} measures a local
  $\langle X_0\rangle$ and a string labelled
  $\langle Y_{L-1}Z_{L-2}\cdots Z_0\rangle$. That is not the same observable
  emphasized in the Week 5 deck. The deck and notebook emphasize the boundary
  correlation
  \[
    \langle X_0Z_1\cdots Z_{L-2}X_{L-1}\rangle,
  \]
  which for $L=4$ is $\langle X_0Z_1Z_2X_3\rangle$.

...
| 2 | **Finite-Size Physics & Majorana Edge Modes** | The finite open chain / edge story: OBC spectrum, near-zero edge modes, exponential edge localisation, hybridisation splitting $E_0(L)\approx 2t(\lvert\mu\rvert/2t)^L$, the sign-filter artefact. | 2–3 | _(unclaimed)_ |

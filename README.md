...
Notes are kept as LaTeX sources in `notes/`. PDFs are generated by CI and linked from the main site index. The Block 4 note is `notes/block4_noise_diagnostic.tex`.

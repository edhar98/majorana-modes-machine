...
Notes are kept as LaTeX sources in `notes/`. PDFs are generated by CI and published under the site notes index:

- [Notes index](https://edhar98.github.io/majorana-modes-machine/notes/)

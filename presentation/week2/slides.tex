...
\begin{frame}{BdG Formalism and Pseudospin Projection}
  ...
  \begin{equation}
    ...
    \end{cases}
  \end{equation}
  $E_k = \pm\sqrt{n_z(k)^2 + n_y(k)^2}$. The topological phase transition : $E_k = 0$. This occurs at the  points $k=0, \pi$ where $n_y(k) \equiv 0$,condition $\mu = \pm 2t$.
\end{frame}

\begin{frame}{Bulk dispersion: topological / critical / trivial}
  \begin{center}
    \includegraphics[width=0.8\linewidth]{block1_01_bulk_dispersion.png}
  \end{center}

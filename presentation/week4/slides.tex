...
\begin{frame}{The Jordan-Wigner mapping}
  ...
  operators, $X, Y, Z$ are the standard Pauli matrices, and $Z_k$ acts only on qubit $k$.
...
\begin{frame}{Many-body qubit spectrum vs BdG spectrum}
  \begin{center}
    \includegraphics[width=\linewidth,height=0.7\textheight,keepaspectratio]{block2_02_qubit_spectrum.pdf}
  \end{center}
  ...
  is manifest directly in the many-body spectrum alongside the BdG modes.
\end{frame}

...
\begin{frame}{The Jordan-Wigner mapping}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{align*}
        c_j^\dagger c_j &= \frac{I - Z_j}{2} \quad \text{(number op.)}\\[4pt]
        c_j^\dagger c_{j+1} + \mathrm{h.c.}
          &= -\frac{X_j X_{j+1} + Y_j Y_{j+1}}{2}\\[4pt]
...
\begin{frame}{Parity gap (qubit) vs BdG splitting — cross-check}
  \begin{center}
    \includegraphics[width=\linewidth]{block2_01_parity_gap_vs_bdg.pdf}
  \end{center}
...
\begin{frame}{Many-body qubit spectrum}
  \begin{center}
    \includegraphics[width=0.82\linewidth]{block2_02_qubit_spectrum.pdf}
  \end{center}

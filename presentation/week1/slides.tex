...
\begin{frame}{Bulk dispersion: trivial / critical / topological}
  \begin{center}
    \includegraphics[width=0.78\linewidth]{block1_01_bulk_dispersion.pdf}
  \end{center}
...
\begin{frame}{Winding number $\nu$}
  ...
  \begin{center}
    \includegraphics[width=0.85\linewidth]{block1_02_winding_loops.pdf}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Phase diagram}
  \begin{center}
    \includegraphics[width=0.80\linewidth]{block1_03_phase_diagram.pdf}
  \end{center}
...
\begin{frame}{Finite-size spectrum (OBC): edge modes appear}
  \begin{center}
    \includegraphics[width=0.80\linewidth]{block1_04_finite_size_spectrum.pdf}
  \end{center}

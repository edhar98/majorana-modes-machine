...
\begin{frame}{Task 1: VQE Circuit Ansatz (Visual)}
    \begin{columns}
        ...
        \fbox{\begin{minipage}{0.9\textwidth}
            \centering
            \includegraphics[width=\textwidth]{block3_week5_ansatz.pdf}
        \end{minipage}}
    \end{columns}
\end{frame}
...
\begin{frame}{Numerical Verification: VQE Convergence Dynamics}
    \begin{columns}
        ...
        \fbox{\begin{minipage}{0.95\textwidth}
            \centering
            \includegraphics[width=\textwidth]{block3_week5_convergence.pdf} 
        \end{minipage}}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            ...
            \fbox{\begin{minipage}{\textwidth}
                \centering
                \includegraphics[width=0.95\textwidth]{block3_week5_meas_correlation.pdf}
            \end{minipage}}
...
\begin{frame}{Task 4: Numerical Evidence: The 1.0 Correlation}
    ...
    \fbox{\begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{block3_week5_correlation.pdf}
    \end{minipage}}
    \begin{itemize}
